          ...
          >
            {shareOptions.map((option, index) => (
              <motion.button
                ...
                className={`w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-[#a1a1aa] transition-all ${option.color}`}
                title={option.name}
              >
                {option.icon}
              </motion.button>
